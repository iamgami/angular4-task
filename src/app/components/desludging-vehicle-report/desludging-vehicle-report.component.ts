...
@Component({
  selector: 'app-desludging-vehicle-report',
  templateUrl: './desludging-vehicle-report.component.html',
  styleUrls: ['./desludging-vehicle-report.component.scss']
})
export class DesludgingVehicleReportComponent implements OnInit {
  opensidebar: any;
  closesidebar: any;
