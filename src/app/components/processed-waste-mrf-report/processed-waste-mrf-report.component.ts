...
@Component({
  selector: 'app-processed-waste-mrf-report',
  templateUrl: './processed-waste-mrf-report.component.html',
  styleUrls: ['./processed-waste-mrf-report.component.scss']
})
export class processedWasteMrfReportComponent implements OnInit {
  opensidebar: any;
  closesidebar: any;
