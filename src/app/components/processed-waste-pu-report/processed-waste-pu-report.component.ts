...
@Component({
  selector: 'app-processed-waste-pu-report',
  templateUrl: './processed-waste-pu-report.component.html',
  styleUrls: ['./processed-waste-pu-report.component.scss']
})
export class ProcessedWastePuReportComponent implements OnInit {
  opensidebar: any;
  closesidebar: any;
