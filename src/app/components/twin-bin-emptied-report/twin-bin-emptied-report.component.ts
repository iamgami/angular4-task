...
@Component({
  selector: 'app-twin-bin-emptied-report',
  templateUrl: './twin-bin-emptied-report.component.html',
  styleUrls: ['./twin-bin-emptied-report.component.scss']
})
export class TwinBinEmptiedReportComponent implements OnInit {
  opensidebar: any;
  closesidebar: any;
